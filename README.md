...
* [x] Сохранять инструменты в SQLite
* [x] Поиск инструментов
* [x] Добавление инструмента в приложение
* [x] Получение актуальной цены
* [x] Получение lot size
* [x] Получение minimum price step
* [x] Поддержка акций
* [x] Поддержка облигаций
* [x] Поддержка фондов
* [x] Поддержка других типов инструментов
...
* [x] Создание портфеля
* [x] Редактирование портфеля
* [x] Удаление портфеля
* [x] Несколько портфелей
* [x] Общий агрегированный портфель
...
* [x] Налоги
* [x] История операций
* [x] Импорт исполненных сделок и денежных операций из PDF-отчёта Т-Банка

### Импорт брокерского отчёта

На странице «Операции» можно выбрать PDF-отчёт Т-Банка. Приложение сначала показывает предпросмотр, и только после явного подтверждения добавляет операции в выбранный портфель.

Импортируются исполненные покупки и продажи из раздела 1.1, а также пополнения и выводы средств. Плановые сделки из раздела 1.2 и итоговые строки отчёта не создают операций. Для облигаций сохраняются НКД и сумма брокерской, биржевой и клиринговой комиссий. Повторная загрузка того же отчёта в портфель блокируется.

Первый адаптер рассчитан на текстовый PDF-формат Т-Банка из примера; отчёты других брокеров потребуют отдельного адаптера.

---

## Phase 5 — Analytics

* [x] Расчёт текущих позиций
* [x] Portfolio value
* [x] Profit / Loss
* [x] Allocation
* [ ] Доходность
